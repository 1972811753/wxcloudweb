...
export const ORBIT_CONFIG: Record<number, { radiusX: number; radiusZ: number; tilt: number; speed: number; color: string }> = {
  0: { radiusX: 6.5,  radiusZ: 6.0,  tilt: 0.15, speed: 0.16, color: '#a78bfa' }, // groom_family
  1: { radiusX: 11.5, radiusZ: 10.6, tilt: 0.55, speed: 0.12, color: '#f9a8d4' }, // bride_family
  2: { radiusX: 16.5, radiusZ: 15.2, tilt: 0.30, speed: 0.09, color: '#6ee7b7' }, // groom_friend
  3: { radiusX: 21.5, radiusZ: 19.8, tilt: 0.70, speed: 0.07, color: '#fcd34d' }, // bride_friend
  4: { radiusX: 26.5, radiusZ: 24.4, tilt: 0.45, speed: 0.05, color: '#93c5fd' }, // colleague
}
